...
SHEETS = {
    ...
    "SALARY-M": {
        ...
        "kind": "master",
        "seed": None,
        # Cost & Revenue report එකට. BASIC SALARY විතරක් අත්‍යවශ්‍යයි —
        # OT-N/OT-D rate හිස්නම් Basic වලින් auto-derive වෙනවා. EPF/ETF default 12/3.
        "headers": [
            "USER ID", "CSS USER NAME", "JOB TITLE", "BASIC SALARY",
            "OT-N RATE", "OT-D RATE", "FIXED INCENTIVE", "EPF %", "ETF %",
            "CONTRACTOR FEE",
        ],
    },
...
OT_N_MULTIPLIER = 1.5            # OT-N rate = hourly × 1.5
OT_D_MULTIPLIER = 2.0            # OT-D rate = hourly × 2.0
EPF_PCT = 12.0                   # EPF = Basic × 12%
ETF_PCT = 3.0                    # ETF = Basic × 3%
